...
export default function TrustStats() {
  return (
    <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-charcoal border-y border-white/5">
        ...
        >
          {stats.map((stat, i) => (
            <div key={i} className="text-center">
              <p className="text-2xl sm:text-3xl font-semibold text-gold font-display mb-1">
                {stat.value}
              </p>
